...
public class Task04 {
    ...
    true, только если значения во всех полях сравниваемых объектов равны.
    4. Выведите снова содержимое множества из пункта 2, убедитесь, что дубликаты удалились.
     */
    public static void main(String[] args) {
        Cat cat1 = new Cat("Мурзик", "Бенгал", 2, "Иван");
        Cat cat2 = new Cat("Пузик", "Сиамец", 4, "Костя");
        Cat cat3 = new Cat("Рыжик", "Мейн-Кун", 5, "Света");
        Cat cat4 = new Cat("Мурзик", "Бенгал", 2, "Иван");
